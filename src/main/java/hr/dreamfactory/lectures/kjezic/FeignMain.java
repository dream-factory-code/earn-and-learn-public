...
import hr.dreamfactory.lectures.kjezic.api.RecommendationAPI;
import hr.dreamfactory.lectures.kjezic.model.Banner;
import hr.dreamfactory.lectures.kjezic.model.BannerResults;
...
public class FeignMain {
    ...
    public static void main(String[] args) {
        ...
        for (Banner banner : result.getResults()) {
            LOGGER.info("Banner image: {}", banner.getUrl());
        }
    }
}
