...
import hr.dreamfactory.lectures.pfribert.api.RecommendationAPI;
import hr.dreamfactory.lectures.pfribert.model.Banner;
import hr.dreamfactory.lectures.pfribert.model.BannerResults;
...
public class FeignMain {
    ...
    public static void main(String[] args) {
        ...
        for (Banner banner : result.getResults()) {
            LOGGER.info("Banner title: {}", banner.getTitle());
        }
